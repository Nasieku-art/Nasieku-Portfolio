...
export default function About() {
  ...
  return (
    <div className="container mx-auto" id="about">
      {/* <div style={{opacity,transition:"opacity 0.1s linear"}} id="about"> */}
      <div className="flex flex-col md:flex-row items-start gap-8">
        <div className="py-3 flex-1">
          ...
          <div className="py-3 space-y-4">
            ...
            <p>
              My journey in technology extends beyond software development.
              I have experience in IT support, digital skills training, and
              community mentorship, where I've helped learners develop
              practical technical skills. These experiences have strengthened
              my communication, leadership, and problem-solving abilities
              while reinforcing my belief that technology should empower
            ...
            <p>
              ...
              development, to build innovative solutions that address
              real-world challenges. Every project I undertake is an
              opportunity to learn, innovate, and deliver secure, scalable,
